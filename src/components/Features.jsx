...
const Features = () => {
                        ...
                        useGSAP(() => {
                          ...
                          animateWithGsap('#features_title', { y: 0, opacity: 1}); // Correct usage of gsap instead of animateWithGsap
                          animateWithGsap('.g_grow',{ scale: 1 , opacity: 1, ease: 'power1' },{ scrub: 5.5 }); // Correct usage of gsap instead of animateWithGsap
                          animateWithGsap('.g_text', { y: 0, opacity: 1, ease: 'power2.inOut', duration: 1 }); // Correct usage of gsap instead of animateWithGsap
                        }, []);
